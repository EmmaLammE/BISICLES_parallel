...
#include "IceConstants.H"
     ...
     &           )
      ...
      integer*8 ch_flops
      COMMON/ch_timer/ ch_flops
      REAL_T a_seconds_per_unit_time
      REAL_T a_ice_density
      REAL_T a_water_density
      REAL_T a_gravity
      REAL_T a_ice_heat_capacity
      REAL_T a_ice_latent_heat
      REAL_T a_ice_conductivity
      REAL_T a_moisture_conductivity
      REAL_T a_ice_pressure_melt_factor
      REAL_T a_triple_point
      REAL_T a_water_fraction_drain
      REAL_T a_water_fraction_max
      REAL_T a_water_drain_factor
      REAL_T a_till_water_drain_factor
      REAL_T a_till_water_max
     ...
     &           0:idsigmahi0)
      ...
      if (floatingMaskNew(i0,i1).eq.FLOATINGMASKVAL) then
