...
extern "C" {
  ...
  void Pf_Main(AmrIceHolderClass *AmrIceHolderPtr,int numCrseIntervals,double dt,\
    double maxTime,int maxStep, int numGridPoints, char pf_plot_prefix, bool PF_VERBOSE); 
