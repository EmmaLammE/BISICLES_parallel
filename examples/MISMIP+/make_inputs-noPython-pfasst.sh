...
mkdir -p scripts-noPython-pfasst
TAGLAP=0
BASEDIR=$PWD
for SGN in 4
do
...
do
	...
	do
	    ...
	    TEMPLATE=inputs.isomip-noPython-pfasst.template
	    ACAB=0.3
...
cp -f .petscrc scripts-noPython-pfasst
